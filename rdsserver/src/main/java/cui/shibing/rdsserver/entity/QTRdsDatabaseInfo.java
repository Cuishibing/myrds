...
public class QTRdsDatabaseInfo extends com.querydsl.sql.RelationalPathBase<TRdsDatabaseInfo> {
    ...
    public void addMetadata() {
        ...
        addMetadata(name, ColumnMetadata.named("name").withIndex(9).ofType(Types.VARCHAR).withSize(32).notNull());
        ...
        addMetadata(userId, ColumnMetadata.named("user_id").withIndex(10).ofType(Types.BIGINT).withSize(19).notNull());
